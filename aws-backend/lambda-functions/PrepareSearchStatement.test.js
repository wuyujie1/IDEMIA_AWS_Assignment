    ...
    it("should call StartSyncExecutionCommand with correct SQL statement for SEARCH operation", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expectedQuery = "SELECT * FROM ".concat(process.env.DB_NAME, ".").concat(process.env.TABLE_NAME, " WHERE 1=1 AND upper(firstname) LIKE upper('test') AND upper(lastname) LIKE upper('testlastname')");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, handler({ queryStringParameters: { test: "test" } })];
                case 1:
                    response = _a.sent();
