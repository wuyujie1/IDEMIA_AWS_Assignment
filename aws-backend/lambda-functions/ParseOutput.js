...
var convertField = function (key, value) {
    if (key === "roomquantity") {
        return Number(value);
    }
...
export var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, parsedResult, columnNames_1, rows;
    return __generator(this, function (_a) {
        try {
            ...
            columnNames_1 = parsedResult[0].Data.map(function (column) { return column.VarCharValue || ""; });
            rows = parsedResult.slice(1).map(function (row) {
                var rowData = {};
                row.Data.forEach(function (cell, index) {
                    var key = columnNames_1[index];
                    var cellValue = cell.VarCharValue || "";
