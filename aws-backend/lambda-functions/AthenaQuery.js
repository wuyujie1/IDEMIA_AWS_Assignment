...
export var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var athena, params, queryExecutionId, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                athena = new Athena({ region: region });
                params = {
                ...
                return [4 /*yield*/, athena.startQueryExecution(params)];
            case 1:
