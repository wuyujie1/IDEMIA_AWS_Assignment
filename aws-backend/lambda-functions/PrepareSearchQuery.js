...
export var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var queryParams, query_1, params, stepFunctions, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                queryParams = event.queryStringParameters || {};
                query_1 = "SELECT * FROM ".concat(dbName, ".").concat(tableName, " WHERE 1=1");
                Object.entries(queryParams).forEach(function (_a) {
                    ...
                    query_1 += " AND upper(".concat(key, ") LIKE upper(").concat(formattedValue, ")");
                });
                params = new StartSyncExecutionCommand({
                    input: JSON.stringify({ "preparedQuery": query_1, "operation": "search" }),
                    name: "Search",
