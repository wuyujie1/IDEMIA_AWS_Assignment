...
export var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonData, columns, values, query, params, stepFunctions, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                values = Object.values(jsonData).map(function (value) {
                    return typeof value === "string" ? "'".concat(value, "'") : value;
                }).filter(function (value) { return value !== null; }).join(", ");
                query = "INSERT INTO ".concat(dbName, ".").concat(tableName, " (").concat(columns, ") VALUES (").concat(values, ")");
